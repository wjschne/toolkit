...
```{r dichomomy, echo=F, fig.cap="A (nearly) true dichotomy", fig.width=6.72, dev="svg", out.width=672, fig.align='center'}
...
```{r dichotomous, fig.cap="A dichomized continuum", dev="svg", echo = F, fig.align='center'}
...
```{r, eval = F, echo = T, ref.label="dichotomous"}
...
```{r Likert, fig.cap="In a Likert-type scale, the distances between categories are undefined.", fig.margin = TRUE, fig.width=3, dev="svg", out.width=300, fig.align='default', echo=FALSE}
...
```{r, ref.label="differentiation", eval=F, echo=T}
```
