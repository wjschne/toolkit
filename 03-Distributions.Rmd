...
The normal distribution is sometimes called the *Gaussian* distribution after its discoverer, Carl Friedrich Gauss. If you are feeling bad for Gauss that most people do not use his name to refer to the normal distribution, don't. Gauss is not languishing in obscurity. He made so many discoveries that his name is all over mathematics and statistics. 
